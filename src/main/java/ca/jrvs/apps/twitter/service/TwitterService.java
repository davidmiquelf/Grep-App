...
public interface TwitterService {
  ...
  /**
   * Post a Tweet along with a geo location. Print Tweet JSON which returned by the Twitter API
   *
  ...
  /**
   * Delete Tweet(s) by id(s). Print Tweet object(s) which returned by the Twitter API
   *
